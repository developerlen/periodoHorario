...
import calendar
from ciclo import *
from horario import cria_horario_legal, cria_feriados
import sys
...
def create_df(date_begin, date_end):
    ...
    date_end = dt(year_end, month_end, calendar.monthrange(
        year_end, month_end)[1], 23, 59)
...
def periodo_horario(abastecimento, ciclo, date_begin, date_end):
    ...
    df.to_excel('df_ph.xlsx')
    print('\n\nDone! --> check the file "df_ph.xlsx" in the main folder\n\n')
...
if __name__ == '__main__':
    ...
    if len(args) == 5:
        ...
        print('4 arguments are expected (ciclo, abastecimento, date_begin, date_end)...')
